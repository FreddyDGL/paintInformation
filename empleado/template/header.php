        ...
        <div class="container-fluid">
            <div class="row justify-content-end">
                ...
                <a class="navbar-brand" href="<?php echo $url ?>/empleado/inicio.php">
                    <img src="../../../img/logo.png" alt="Logo" width="55" height="34"
            ...
            <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo $url ?>/empleado/sections/venta/venta.php">Registrar Venta
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo $url ?>/empleado/sections/productos/productos.php">Productos</a>
                        </li>
                        <li class="nav-item">
