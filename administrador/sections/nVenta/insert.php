...
if (empty($ide)|| empty($idu)|| empty($idc)|| empty($idp)|| empty($can)|| empty($pv)|| empty($tot)|| empty($fec)){
	...
	$result = mysqli_query($conection,"INSERT INTO venta(ID, IDUsuario, IDCliente, IDProducto, PrecioVenta, Cantidad, Total, Fecha)VALUES('$ide', '$idu', '$idc', '$idp','$pv', '$can', '$tot', '$fec')");
