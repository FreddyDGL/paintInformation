        ...
        <nav class="navbar bg-body-tertiary">
                <div class="container-fluid">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                                ...
                                aria-controls="offcanvasWithBothOptions">Opciones Administrador</button>

                        <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1"
                                id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                                <div class="offcanvas-header">
                                        <h5 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Opciones
                                                Administrador</h5>
                                ...
                                <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                                ...
                                                <li class="nav-item">
                                                        <a class="nav-link"
                                                                href="<?php echo $url ?>/administrador/sections/venta.php">Registrar
                                                                Venta
                                                        </a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                        <a class="nav-link"
                                                                href="<?php echo $url ?>/administrador/sections/gastos.php">Registrar
                                                                Gastos
                                                        </a>
                                                </li>
                                                <li class="nav-item">
                                                        <a class="nav-link"
                                                                href="<?php echo $url ?>/administrador/sections/estadoCuenta.php">Consultar
                                                                Estado
                                                                Actual
                                                        </a>
                                                </li>
